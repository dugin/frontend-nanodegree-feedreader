...
$(
  (function() {
    ...
    describe('RSS Feeds', function() {
      ...
      it('contain URL and is not empty', function() {
      ...
      it('contain a name and is not empty', function() {
        allFeeds.forEach(feed => {
    ...
    describe('Menu', function() {
      ...
      it('is shown after clicked and hidden when clicked again', function() {
    ...
    describe('Initial Entries', function() {
      ...
      beforeEach(function(done) {
        loadFeed(0).then(function(entries) {
          done();
        });
      });
